...
import { Mail as MailIcon, Lock as LockIcon, Eye as EyeIcon, EyeOff as EyeOffIcon, AlertCircle as AlertCircleIcon } from 'lucide-react';
...
const Login: React.FC = () => {
  ...
  return <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex flex-col items-center pt-16 pb-8">
        <img src="/icon.png" alt="Salvatore Marketplace Logo" className="w-20 h-20 mb-4" />
      ...
      <div className="px-6 flex-1">
        {message && <div className="mb-4 bg-yellow-50 p-3 rounded-lg border border-yellow-200">
            <div className="flex items-center text-yellow-700">
              <AlertCircleIcon className="w-5 h-5 mr-2" />
              <span>{message}</span>
            </div>
          </div>}
        {errors.general && <div className="mb-4 bg-red-50 p-3 rounded-lg border border-red-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="relative">
              ...
              <input type="text" name="email" value={formData.email} onChange={handleChange} placeholder="Email Address" className={`w-full py-3 pl-10 pr-3 border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500`} />
            </div>
